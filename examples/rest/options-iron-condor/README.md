...
🎯 Using filters: {'min_net_credit': 0.50, 'max_risk': 2.00, 'min_probability': 60.0%, 'min_credit_ratio': 0.35, 'max_capital_per_condor': 500.0}
...
**Minimum Credit Ratio**: Ensures the collected premium equals at least X% of the widest spread. Example: `--min-credit-ratio 0.35` targets ≈35% return on risk.
